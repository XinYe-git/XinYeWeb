...
export default class news extends Component {
    ...
    getUser(page){
        Axios.get("/ygq/user_act/index",{
            ...
            this.setState({
                ...
                adArr:suc.data.message.map(item=>{
                    item.isChange=false
                    return item
                })
            })
    ...
    sentData(){
        ...
        Axios({
            url:'/ygq/user_act/add',
            method : 'post',
            headers: { "token": window.localStorage.getItem( "token" ) },
            data:formData
        }).then(suc=>{
            if(suc.data.success==='记录添加成功'){
                window.scrollTo(0,0);
                window.location.reload()
            }
        }).catch(err=>{
                ...
                <div className="administrator-content">
                    <div className="administrator-head">
                        <div className="administrator-tr">
                            <div className="administrator-cell">标题</div>
                    ...
                    <div className="administrator-body">
                        ...
                        }
                        {
                            ...
                            <div className="administrator-tr administrator-work-tr" >
                                <div className="administrator-cell">  
                                    <input type="text" data-type="title" onChange={this.getAddData.bind(this)}/>
                                </div>
                                <div className="administrator-cell">  
                                    <input type="text" data-type="content" onChange={this.getAddData.bind(this)}/>
                                </div>
